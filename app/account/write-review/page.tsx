                    ...
                    <div className="px-4 sm:px-6">
                        ...
                        <div className="flex flex-wrap gap-4">
                            {[...Array(5)].map((_ ,index)=>(
                                ...
                                <label className="relative rounded-lg w-22 h-22 flex flex-col items-center justify-center gap-1 cursor-pointer bg-[#EFF0F6]">
                                    <input type="file" className="absolute inset-0 -z-10 rounded-lg opacity-0"/>
